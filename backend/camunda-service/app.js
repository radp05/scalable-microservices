...
const appConf = commonConf.services.camunda;
let mongoConf = commonConf.databases.mongodb;

// Add custom dependencies
const config = require('./config/config');
const camundaRoutes = require('./routes/routes');
...
process.env.CAMUNDA_BASE_URL = commonConf.CAMUNDA_BASE_URL || config.CAMUNDA_BASE_URL;
...
app.use(appConf.apiBase, camundaRoutes);
