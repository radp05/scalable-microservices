...
export class EditAppComponent implements OnInit {
  ...
  constructor(
    @Optional() public dialogRef: MatDialogRef<EditAppComponent>,
  ...
  public onClickSaveTemplate(model) {
    this.apiService.createTemplate(model).subscribe(response => {
   ...
   * onClickEditTemplate
   */
  public onClickEditTemplate(model) {

    this.apiService.editTemplate(model).subscribe(response => {
      console.log("Done!!!!", response);
